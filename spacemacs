...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(editorconfig all-the-icons)
...
you should place your code here."
  ...
  (setcdr (assoc "*rspec-compilation*" popwin:special-display-config) '(:dedicated t :position bottom :stick t :noselect t :height 0.2))
  )
